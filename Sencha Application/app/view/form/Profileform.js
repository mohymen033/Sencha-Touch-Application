Ext.define('MyApp.view.form.Profileform', {
            ...
            items: [
                {
					...
					items: [
														...
														
						{
							...
							html:'<form><div id="recaptcha_div_profile"></div></form>'//,
							//id:'recaptcha'
                    ...
                    items: [
                       	 ...
                       	 {xtype: 'spacer'},
                        {
                            text: 'Exit',
                            handler: function() {
								Ext.getCmp('Profileform').reset();
								Ext.getCmp('Profileform').hide();
                        ...
                        },
                        {
							...
							handler: function() {
							alert('fdfd');
							var form=Ext.getCmp('Profileform');
							//form1.hide();
							...
							form.submit({
								...
								var recaptcha_challenge_field=form._items.items[0].items.items[7].innerHtmlElement.dom.firstElementChild['recaptcha_challenge_field'].value;
										...
										//Recaptcha.destroy();
										 Recaptcha.create("6LdC9c0SAAAAAERjCrgFsaf2Jv_gfhkHsCq3TZ1x", "recaptcha_div_profile", {
											theme: "red",
