Ext.define('Contactassignedreportlist', {
...
Ext.create('Ext.data.Store', {
      ...
      id: 'ListStoreassignedreportlist',
    model: 'Contactassignedreportlist',
...
xtype:'assignedreportlist',
    ...
    config: {
		...
		alert('Server-side failure code'+response.status);
				...
				,
                store: 'ListStoreassignedreportlist', 
				itemSelector: 'div.contact',
                //itemTpl: '<div class="contactassignedreportlist"><strong>{Id}</strong></div>',
				itemTpl: '<div class="contactassignedreportlist"><strong>Report Id:{Id}</strong></br><strong>Point Id: {poiName}</strong></br><strong>Point Type: {poiTypeName}</strong></div>',
